...
import Cookies from "js-cookie"; // Asegúrate de tener esto para acceder a las cookies
...
const Personalizacion = ({ personalizacionId }) => {
  ...
  const guardarConfiguracion = () => {
    ...
    const usuarioId = userData.id; // Suponiendo que el ID del usuario está en 'id' dentro de la cookie
    ...
    axios
      .post(`${apiURL}/personalizacion`, {
        ...
        usuarioId,          // Enviar el usuarioId desde la cookie
