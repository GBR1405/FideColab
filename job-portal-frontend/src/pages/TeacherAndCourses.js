                    ...
                    <div className="container__content">
                        <div className="content__box">
                                    ...
                                    <tbody>
                                        {loading ? (
                                            ...
                                            professors.map((professor) => (
                                                ...
                                                >
                                                    <td>{professor.Usuario_ID_PK}</td>
                                                    <td>{professor.Nombre} {professor.Apellido1} {professor.Apellido2}</td>
                            ...
                            <div className="box__bottom">
                                ...
                                {selectedTeacher && (
                                    <div className="bottom__button">
                                        <button onClick={handleDeselectTeacher} type="submit">Deseleccionar Profesor</button>
                                    </div>
                                )}
                            </div>
                        </div>
                            ...
                            <table id="tableCourses">
                                <thead>
                                    <tr>
                                        <th>Curso</th>
                                        <th>Grupo</th>
                                        {selectedTeacher && <th>Acciones</th>} {/* Mostrar columna de acciones solo si hay un profesor seleccionado */}
                                    </tr>
                                </thead>
                                <tbody>
                                    {loading ? (
                                        ...
                                        (selectedTeacher ? linkedCourses : courses).map((course) => (
                                            <tr
                                                key={course.id}
                                                data-id={course.id}
                                                onClick={() => handleRowClick(course.id, 'course')}
                                            >
                                                <td>{`${course.codigo ?? "Sin código"} - ${course.nombre ?? "Sin nombre"}`}</td>
                                                <td>{`G${course.grupo ?? "Sin grupo"}`}</td>
